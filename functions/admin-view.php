...
<div class="wrap">
        ...
        <div class="klen_wrapper">
            <div class="klen_wrapper__col">
                ...
                <?php switch($tab) :
                    ...
                    case 'design':?>
                        ...
                        <table class="form-table">
                            <tbody>
                                <tr>
                                    <th scope="row"><label for="klen_style"><?=__('Choose style','klen_admin');?></label></th>
                                    <td>
                    ...
                    default:?>
                        ...
                        <table class="form-table">
                            <tbody>
                                ...
                                <tr>
                                    <th scope="row"><?=__('Testing mode','klen_admin');?></th>
                                    <td>
                                        <fieldset>
